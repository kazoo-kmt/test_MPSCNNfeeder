...
//      }
      ...
      for layerName in layerNames {
        ...
        if layerGroup.objectNames().count > 0 {
          ...
          let dimension = wtDataset.space.dims
...
//          var wtBuffer = Array<Float>(repeating: 0.0, count: wtLength)
//          var bsBuffer = Array<Float>(repeating: 0.0, count: bsLength)
//          wtData.getBytes(&wtBuffer, length: wtData.length)
//          bsData.getBytes(&bsBuffer, length: bsData.length)
